...
cp -ar common %{buildroot}/%{_datadir}/%{upstream_name}/compat
cp -ar docker %{buildroot}/%{_datadir}/%{upstream_name}/compat
if [ -d docker_config_scripts ]; then
  cp -ar docker_config_scripts %{buildroot}/%{_datadir}/%{upstream_name}/compat
fi
...
if [ -d networks ]; then
  cp -ar networks %{buildroot}/%{_datadir}/%{upstream_name}/compat
fi
cp -ar validation-scripts %{buildroot}/%{_datadir}/%{upstream_name}/compat
cp -ar deployed-server %{buildroot}/%{_datadir}/%{upstream_name}/compat
cp -ar ci %{buildroot}/%{_datadir}/%{upstream_name}/compat
cp -ar plan-samples %{buildroot}/%{_datadir}/%{upstream_name}/compat
cp -ar roles %{buildroot}/%{_datadir}/%{upstream_name}/compat
cp -ar scripts %{buildroot}/%{_datadir}/%{upstream_name}/compat
cp -ar tools %{buildroot}/%{_datadir}/%{upstream_name}/compat
if [ -d examples ]; then
  rm -rf examples
fi
